...
# give it an explicit, verbatim escape hatch to use instead. Exposed as a
# constant so other modules (e.g. analytics) can detect refusals by exact
# string match without duplicating the phrase.
